...
export default function TheImportanceOfHavingABig() {
  return (<>
        <div>
        <p className="text-3xl pb-2"><b>The Importance of Having a Big</b></p>

        <Image src='/image/blog/bigs/rachel-big.jpg' alt='Dan Abra' width={600} height={250}></Image>
                ...
                <p className="text-lg"> <b>Asian American Student Union</b></p><br/>
                ...
                <p className="text-lg"> <b>Beyond AASU</b></p><br/>
                ...
                <p className="text-lg"> <b>Takeaway</b></p><br/>
                ...
                <Image src='/image/blog/bigs/big-photo-dump.jpg' alt='Dan Abra' width={600} height={250}></Image><br/>
